...
public static class HealthCheckExtensions
{
    ...
    private static readonly string[] _tags = [MONGODB];
    private static readonly string[] _env_tags = [ENV];
    ...
    {
        services.AddHealthChecks().AddCheck<EnvironmentHealthCheck>("EnvironmentHealthCheck", tags: _env_tags);
        return services;
    }
    ...
    {
        services.AddHealthChecks().AddCheck<MongoDBHealthCheck>("MongoDB", tags: _tags);
        return services;
    }
